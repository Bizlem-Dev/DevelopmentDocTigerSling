	...
	try {
		...
		for (int i = 0; i < fullloaddata.length(); i++) {
			...
			if (!USERNode.hasNode(username)) {
				...
				sendGet("http://prod.bizlem.io:8082/portal/process/shoppingcart/ShoppingCartUserCheckService?userId="
			...
			if (!serviceidnode1.hasNode(group)) {
				groupnode = serviceidnode1.addNode(serviceid);
			} else {
				groupnode = serviceidnode1.getNode(serviceid);
			}
			// ...........................................................................
			// applicatio 2nd part
