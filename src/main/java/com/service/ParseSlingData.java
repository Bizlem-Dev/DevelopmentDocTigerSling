...
public interface  ParseSlingData   {
	...
	public String getADVandTemplatedata(String email, String group, String templatename, String AttachtempalteType,String SFObject, String Primery_key, String Primery_key_value, JSONObject SFData, SlingHttpServletResponse response);
	public JSONObject getMailTemplatedata(String email, String group, String mailtemplatename, String SFObject, String Primery_key, String Primery_key_value,JSONObject SFData, SlingHttpServletResponse response);
	...
	public Node validationmethod(String freetrialstatus, String email,String group, Session session, SlingHttpServletRequest request, SlingHttpServletResponse response);
	public String updateDocGenCounter(String email, String freetrialstatus,Node update_node, SlingHttpServletResponse response);
